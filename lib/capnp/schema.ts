...
export class Node extends $.Struct {
  ...
  * */
  ...
  get endByte(): number {
    return $.utils.getUint32(44, this);
  }
  set endByte(value: number) {
    $.utils.setUint32(44, value, this);
  }
  toString(): string {
...
* */
export class CodeGeneratorRequest_RequestedFile_FileSourceInfo_Identifier_Member extends $.Struct {
  static readonly _capnp = {
    displayName: "member",
    id: "fc69d5e1d630a151",
    size: new $.ObjectSize(24, 0)
  };
  get parentTypeId(): bigint {
    return $.utils.getUint64(8, this);
  }
  set parentTypeId(value: bigint) {
    $.utils.setUint64(8, value, this);
  }
  get ordinal(): number {
  ...
  toString(): string {
    return "CodeGeneratorRequest_RequestedFile_FileSourceInfo_Identifier_Member_" + super.toString();
  }
}
export const CodeGeneratorRequest_RequestedFile_FileSourceInfo_Identifier_Which = {
  TYPE_ID: 0,
  MEMBER: 1
} as const;
export type CodeGeneratorRequest_RequestedFile_FileSourceInfo_Identifier_Which = (typeof CodeGeneratorRequest_RequestedFile_FileSourceInfo_Identifier_Which)[keyof typeof CodeGeneratorRequest_RequestedFile_FileSourceInfo_Identifier_Which];
export class CodeGeneratorRequest_RequestedFile_FileSourceInfo_Identifier extends $.Struct {
  ...
  * */
  get typeId(): bigint {
    $.utils.testWhich("typeId", $.utils.getUint16(16, this), 0, this);
    return $.utils.getUint64(8, this);
  }
  get _isTypeId(): boolean {
  ...
  * Identifier refers to a member of a type.
  * */
  get member(): CodeGeneratorRequest_RequestedFile_FileSourceInfo_Identifier_Member {
    $.utils.testWhich("member", $.utils.getUint16(16, this), 1, this);
    return $.utils.getAs(CodeGeneratorRequest_RequestedFile_FileSourceInfo_Identifier_Member, this);
  }
  _initMember(): CodeGeneratorRequest_RequestedFile_FileSourceInfo_Identifier_Member {
    $.utils.setUint16(16, 1, this);
    return $.utils.getAs(CodeGeneratorRequest_RequestedFile_FileSourceInfo_Identifier_Member, this);
  }
  get _isMember(): boolean {
  ...
  toString(): string {
    return "CodeGeneratorRequest_RequestedFile_FileSourceInfo_Identifier_" + super.toString();
  }
  which(): CodeGeneratorRequest_RequestedFile_FileSourceInfo_Identifier_Which {
    return $.utils.getUint16(16, this) as CodeGeneratorRequest_RequestedFile_FileSourceInfo_Identifier_Which;
  }
}
export class CodeGeneratorRequest_RequestedFile_FileSourceInfo extends $.Struct {
  static readonly Identifier = CodeGeneratorRequest_RequestedFile_FileSourceInfo_Identifier;
  static readonly _capnp = {
    displayName: "FileSourceInfo",
    id: "f8ea2bf176925da0",
    size: new $.ObjectSize(0, 1)
  };
  static _Identifiers: $.ListCtor<CodeGeneratorRequest_RequestedFile_FileSourceInfo_Identifier>;
  _adoptIdentifiers(value: $.Orphan<$.List<CodeGeneratorRequest_RequestedFile_FileSourceInfo_Identifier>>): void {
    $.utils.adopt(value, $.utils.getPointer(0, this));
  }
  _disownIdentifiers(): $.Orphan<$.List<CodeGeneratorRequest_RequestedFile_FileSourceInfo_Identifier>> {
    return $.utils.disown(this.identifiers);
  }
  get identifiers(): $.List<CodeGeneratorRequest_RequestedFile_FileSourceInfo_Identifier> {
    return $.utils.getList(0, CodeGeneratorRequest_RequestedFile_FileSourceInfo._Identifiers, this);
  }
  _hasIdentifiers(): boolean {
    return !$.utils.isNull($.utils.getPointer(0, this));
  }
  _initIdentifiers(length: number): $.List<CodeGeneratorRequest_RequestedFile_FileSourceInfo_Identifier> {
    return $.utils.initList(0, CodeGeneratorRequest_RequestedFile_FileSourceInfo._Identifiers, length, this);
  }
  set identifiers(value: $.List<CodeGeneratorRequest_RequestedFile_FileSourceInfo_Identifier>) {
    $.utils.copyFrom(value, $.utils.getPointer(0, this));
  }
  toString(): string {
    return "CodeGeneratorRequest_RequestedFile_FileSourceInfo_" + super.toString();
  }
}
export class CodeGeneratorRequest_RequestedFile extends $.Struct {
  ...
  static readonly FileSourceInfo = CodeGeneratorRequest_RequestedFile_FileSourceInfo;
  static readonly _capnp = {
  ...
  * */
  ...
  _adoptFileSourceInfo(value: $.Orphan<CodeGeneratorRequest_RequestedFile_FileSourceInfo>): void {
    $.utils.adopt(value, $.utils.getPointer(2, this));
  }
  _disownFileSourceInfo(): $.Orphan<CodeGeneratorRequest_RequestedFile_FileSourceInfo> {
    return $.utils.disown(this.fileSourceInfo);
  }
  get fileSourceInfo(): CodeGeneratorRequest_RequestedFile_FileSourceInfo {
    return $.utils.getStruct(2, CodeGeneratorRequest_RequestedFile_FileSourceInfo, this);
  }
  _hasFileSourceInfo(): boolean {
    return !$.utils.isNull($.utils.getPointer(2, this));
  }
  _initFileSourceInfo(): CodeGeneratorRequest_RequestedFile_FileSourceInfo {
    return $.utils.initStructAt(2, CodeGeneratorRequest_RequestedFile_FileSourceInfo, this);
  }
  set fileSourceInfo(value: CodeGeneratorRequest_RequestedFile_FileSourceInfo) {
    $.utils.copyFrom(value, $.utils.getPointer(2, this));
  }
  toString(): string {
...
CodeGeneratorRequest_RequestedFile_FileSourceInfo._Identifiers = $.CompositeList(CodeGeneratorRequest_RequestedFile_FileSourceInfo_Identifier);
